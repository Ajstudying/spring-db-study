...
//  -> 응답이 데이터, 문자열, 숫자, 웹페이지, 파일로도 가능
//@ResponseBody
//  -> 응답형식이 객체면(object, list ...) JSON 형식으로 변환해서 반환함.
//@RestController
...
public class AccountController {
    ...
    public void func() {
        ...
        // 컴파일 되면 생길테니까, 그걸 감안해서 인텔리제이에서 쓸 수 있게 한 것.
        acc.getAno();
        acc.setAno("002");
    }
